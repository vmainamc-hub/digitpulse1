...
function toScanResult(
  ...
  return {
    ...
    qualificationReason: strictQualified
      ? "All authoritative production gates satisfied"
      : (vetoes[0] ?? "Authoritative production gates not satisfied"),
    scannedAt: now,
    ...
    invalidationReason:
      contract.state === "INVALIDATED" ? "Authoritative lifecycle invalidated" : null,
  } as ScanResult;
}
